# The batching cliff: what running requests together actually buys you
...
[The Inference Wall](https://mapathak-commits.github.io/inference-wall/) · [All posts](https://mapathak-commits.github.io/inference-wall/articles/) · **Part 3**

[Part 1](https://mapathak-commits.github.io/inference-wall/articles/part-1/) ended on a wall: the 4B model saturating at about seven requests a second, held
...
The mechanism is the one from the [primer](https://mapathak-commits.github.io/inference-wall/articles/primer/): one weight-stream per step, shared across the whole
...
![Throughput against the running-batch cap on a log axis: a steep weight-read amortization climb from 49 to 1,050 tokens a second, then flat to 1,091 where per-sequence work dominates](fig3-batching-cliff.png)
...
- At cap 256, ITL median rises to **70 ms** and p99 to **458 ms**. Every decode step now
  ...
  the freeze [Part 2](https://mapathak-commits.github.io/inference-wall/articles/part-2/) measured.
...
**Previous:** [Part 2: The prefill freeze](https://mapathak-commits.github.io/inference-wall/articles/part-2/) · **Next:** Part 4, coming next Friday · [All posts](https://mapathak-commits.github.io/inference-wall/articles/)
