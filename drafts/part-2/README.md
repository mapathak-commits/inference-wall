...
![Every decode kernel in the trace window as a tick on a 367 ms timeline: a steady heartbeat with visibly stretched gaps where prefill chunks take their turn, the widest flagged at 4 ms](fig2b-decode-heartbeat.png)
