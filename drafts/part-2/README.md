...
kernel. If you have not read [Part 1](https://mapathak-commits.github.io/inference-wall/articles/part-1/), all you
...
Recall the two phases from the [primer](https://mapathak-commits.github.io/inference-wall/articles/primer/).
...
![Engine steps reconstructed from the trace: while the prefill is being interleaved the victims' steps tick every 39 ms, and the instant the injected prompt finishes they snap back to every 22 ms](fig2b-step-heartbeat.png)
...
![Decode-kernel gap percentiles from the trace: p50 549 microseconds, p90 1,182, p99 3,988 — the GPU never sits idle for more than about 4 ms](fig2-decode-gap-percentiles.png)
