...
kernel. (If you have not read [Part 1]({{ '/articles/part-1/' | relative_url }}), all you need is its punchline: this 4B model, on one
...
Recall the two phases from the [primer]({{ '/articles/primer/' | relative_url }}): **prefill** reads a whole prompt in one dense burst
