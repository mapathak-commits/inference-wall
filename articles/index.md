...
| **Part 4** | [Attention internals]({{ '/articles/part-4/' | relative_url }}) | open one prompt on a CPU and watch it: a deep head dumps its attention on the word "The," and that token's state towers 12x over the rest |
